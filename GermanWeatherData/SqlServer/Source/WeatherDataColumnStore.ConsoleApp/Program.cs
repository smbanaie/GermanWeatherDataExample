...
using TinyCsvParser;
using WeatherDataColumnStore.ConsoleApp.Extensions;
using WeatherDataColumnStore.Csv.Parser;
using WeatherDataColumnStore.Sql.Client;

namespace WeatherDataColumnStore.ConsoleApp
{
